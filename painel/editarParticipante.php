...
if(!isset($_GET['id'])){
  exit(header("location: localizaCadastros.php"));
}else{
  $id = $_GET['id'];
  ...
  $exec = new Mysqlsan();
  $dados = $exec->querys('id, nome, email, categoria, telefone, cargo, cpf, wid, token', 'tb_cadastro',2,$id);
}
?>
    ...
    <div class="d-lg-flex flex-lg-row">
	   ...
	   require('components/navbar_basic.php');
        ...
        <div class="col-12 col-lg-10">
            <?php require('components/editarParticipante.php'); ?>
        </div>
    </div>
